...
$sql = "SELECT temperature FROM datalogger where sensor = 0 ORDER BY date_time DESC LIMIT 1";
$result = mysqli_query($conn, $sql);
...
$sql = "SELECT humidity FROM datalogger where sensor = 0 ORDER BY date_time DESC LIMIT 1";
$result = mysqli_query($conn, $sql);
